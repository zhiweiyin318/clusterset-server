...
func NewCacheWatcher(user user.Info, visibleResources sets.String, authCache WatchableCache, includeAllExistingProjects bool) *cacheWatcher {
...
func (w *cacheWatcher) GroupMembershipChanged(name string, users, groups sets.String) {
	if !w.visibleResources.Has("*") && !w.visibleResources.Has(name) {
